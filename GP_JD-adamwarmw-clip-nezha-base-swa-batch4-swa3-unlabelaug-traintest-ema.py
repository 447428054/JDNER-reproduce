...
import logging
import time
from bert4keras.optimizers import Adam, extend_with_piecewise_linear_lr, extend_with_parameter_wise_lr, extend_with_weight_decay, extend_with_exponential_moving_average
from utils.optimizer import calc_train_steps
from swa.keras import SWA
import os
os.environ["CUDA_VISIBLE_DEVICES"] = "0"

savedir = './saveGP-nezha-base-clip-1-swa3-unlabelaugtime20-traintest-ema/10-adamwarmw-2e-6-batch4-epo4'
datadir = './data'
datatype = 'JD5'
bert_type = 'nezha'
model_scale = 'base'
optimizertype = 'adamwarmwema'
is_flat = True
...
# bert配置
config_path = '/home/root1/lizheng/workspace/2022/pretraining/augtime20-traintest-transpretrain-nezha-base-ngram-epo3/bert_config.json'
checkpoint_path = '/home/root1/lizheng/workspace/2022/pretraining/augtime20-traintest-transpretrain-nezha-base-ngram-epo3/bert_model.ckpt'
dict_path = '/home/root1/lizheng/workspace/2022/pretraining/augtime20-traintest-transpretrain-nezha-base-ngram-epo3/vocab.txt'
...
elif optimizertype == 'adamwarmwema':
    total, warmsteps = calc_train_steps(32000, batch_size, epochs, warmup_proportion)
    AdamW = extend_with_weight_decay(Adam)
    AdamWLR = extend_with_piecewise_linear_lr(AdamW)
    AdamWLREMA = extend_with_exponential_moving_average(AdamWLR)
    optimizer = AdamWLREMA(learning_rate=learning_rate,
                        weight_decay_rate=weight_decay,
                        lr_schedule={warmsteps: 1, total: 0.1},
                        clipvalue=1
                        )
