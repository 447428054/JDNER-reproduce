...
from models import GlobalPointerMFV2
import os
os.environ["CUDA_VISIBLE_DEVICES"] = ""

savedir = './saveGP-nezha-base-clip-1-swa3-pinyinzixingV2/10-adamwarmw-2e-6-batch4'
datadir = './data'
datatype = 'JD5'
bert_type = 'nezha'
model_scale = 'base'
...
print(len(vocab_pinyin))
print(len(vocab_zixing))
        ...
        for is_end, d in self.sample(random):
            ...
            if len(batch_token_ids) == self.batch_size or is_end:
                ...
                for bid, b_pinyin_ids in enumerate(batch_pinyin_ids):
                    ...
                    # padnums = maxlen - len(b_pinyin_ids)
                ...
                for bid, b_zixing_ids in enumerate(batch_zixing_ids):
                    ...
                    # padnums = maxlen - len(b_zixing_ids)
...
output = GlobalPointerMFV2(len(categories), 64, len(vocab_pinyin), len(vocab_zixing))(model.output, pinyin=pinyin_input, zixing=zixing_input)
