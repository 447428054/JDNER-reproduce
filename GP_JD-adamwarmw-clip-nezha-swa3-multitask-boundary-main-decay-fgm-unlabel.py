...
savedir = './saveGP-nezha-base-clip-1-swa3-multask-boundary-FGM/10-adamwarmw-2e-5-0.005'
datadir = './data'
datatype = 'JD5'
bert_type = 'nezha'
model_scale = 'base'
...
# bert配置
config_path = '/home/root1/lizheng/workspace/2022/pretraining/transpretrain-traintestAB-unlabel-nezha-rawbase-ngram-epo26-epo3/bert_config.json'
checkpoint_path = '/home/root1/lizheng/workspace/2022/pretraining/transpretrain-traintestAB-unlabel-nezha-rawbase-ngram-epo26-epo3/bert_model.ckpt'
dict_path = '/home/root1/lizheng/workspace/2022/pretraining/transpretrain-traintestAB-unlabel-nezha-rawbase-ngram-epo26-epo3/vocab.txt'
...
class data_generator(DataGenerator):
    ...
    def __iter__(self, random=False):
        batch_token_ids, batch_segment_ids, batch_labels, batch_bd_labels = [], [], [], []
        for is_end, d in self.sample(random):
            ...
            bdlabels = np.zeros((1, maxlen, maxlen))
            ...
            batch_bd_labels.append(bdlabels[:, :len(token_ids), :len(token_ids)])
            if len(batch_token_ids) == self.batch_size or is_end:
                batch_token_ids = sequence_padding(batch_token_ids)
                batch_segment_ids = sequence_padding(batch_segment_ids)
                batch_labels = sequence_padding(batch_labels, seq_dims=3)
                batch_bd_labels = sequence_padding(batch_bd_labels, seq_dims=3)

                yield [batch_token_ids, batch_segment_ids], [batch_labels, batch_bd_labels]
                batch_token_ids, batch_segment_ids, batch_labels, batch_bd_labels = [], [], [], []
...
model.compile(
    ...
    loss_weights={'global_pointer_1': 1, 'global_pointer_2': 0.005},
    optimizer=optimizer,
    metrics={'global_pointer_1': global_pointer_f1_score, 'global_pointer_2': global_pointer_f1_score}
)
...
# mainmodel.load_weights('/home/root1/lizheng/workspace/2022/back/GlobalPointer-main/saveGPfinetuning1stageswa-full-nezha-ngram-traintest2-epo5/10-adamwarmw-8e-6/best_model_0.weights')
