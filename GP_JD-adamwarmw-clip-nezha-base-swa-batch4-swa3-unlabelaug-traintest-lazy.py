...
savedir = './saveGP-nezha-base-clip-1-swa3-unlabelaugtime20-traintest-lazy/10-adamwarmw-2e-6-batch4-epo4'
datadir = './data'
datatype = 'JD5'
bert_type = 'nezha'
model_scale = 'base'
...
for output in model.outputs:
    embedding_layer = search_layer(output, 'Embedding-Token')
    if embedding_layer is not None:
        break
    embedding_layers.append(embedding_layer)
optimizer = LazyOptimizer(optimizer, embedding_layers)
